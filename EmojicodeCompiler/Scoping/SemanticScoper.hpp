...
public:
    ...
    Scope& pushArgumentsScope(const std::vector<Argument> &arguments, const SourcePosition &p);
...
protected:
    /// This method is called by the FunctionPAG after all arguments were set. Subclasses may override it.

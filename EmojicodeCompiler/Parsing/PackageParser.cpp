    ...
    while (stream_.hasMoreTokens()) {
        ...
        switch (theToken.value()[0]) {
            ...
            case E_WALE: {
                ...
                parseTypeDefinitionBody(type, nullptr, type.typeDefinition()->package() == package_);
...
void PackageParser::parseGenericArgumentList(TypeDefinition *typeDef, TypeContext tc) {
